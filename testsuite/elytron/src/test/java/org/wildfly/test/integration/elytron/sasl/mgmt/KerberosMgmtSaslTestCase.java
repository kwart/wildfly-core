...
@org.wildfly.core.testrunner.ServerSetup({ KerberosMgmtSaslTestCase.Krb5ConfServerSetupTask.class, //
...
public class KerberosMgmtSaslTestCase {
    ...
    protected static final int CONNECTION_TIMEOUT_IN_MS = TimeoutUtil.adjust(60 * 1000);

    private static final String NAME = KerberosMgmtSaslTestCase.class.getSimpleName();
    private static final int LDAP_PORT = 10389;
    private static final String LDAP_URL = "ldap://" + NetworkUtils.formatPossibleIpv6Address(
